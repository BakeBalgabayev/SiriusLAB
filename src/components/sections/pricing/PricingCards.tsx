...
const plans = [
  {
    ...
    featured: false,
    features: [
      "Базовая настройка систем под процесс компании",
      "Настройка шаблонов документов до 3 шт.",
      "Настройка доступов для сотрудников до 7 чел.",
      "Создание и настройка номенклатуры",
      "Настройка торгового оборудования на 2 точки",
      "Обучение сотрудников по работе в системе",
      "Обучение по администрированию до 1 чел.",
  ...
  },
  {
    ...
    features: [
      ...
      "Обучение по администрированию до 1 чел.",
      "Гарантийная поддержка 1 месяц",
      "Интеграция с Kaspi магазином 1 магазин",
    ],
  },
  {
    badge: "Максимальный",
      ...
      <Container>
        {plans.map((plan) => (
          <Card key={plan.name} $featured={plan.featured}>
            ...
            <CTAButton href="/contact">Оставить заявку</CTAButton>
